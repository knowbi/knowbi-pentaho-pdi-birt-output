...
public class BIRTOutputDialog extends BaseStepDialog implements StepDialogInterface
{
  ...
  private TableView wFields;
	...
	public BIRTOutputDialog(Shell parent, Object in, TransMeta transMeta, String sname)
	{
		...
		else stepname=BaseMessages.getString(PKG, "BIRTReportOutputDialog.DefaultStepName"); //$NON-NLS-1$
	}
	...
	public String open()
	{
		...
		shell.setText(BaseMessages.getString(PKG, "BIRTReportOutputDialog.Shell.Text")); //$NON-NLS-1$
		...
		wlStepname.setText(BaseMessages.getString(PKG, "BIRTReportOutputDialog.StepName.Label")); //$NON-NLS-1$
		...
		wlInput.setText(BaseMessages.getString(PKG, "BIRTReportOutputDialog.InputFilename.Label")); //$NON-NLS-1$
        ...
        wlOutput.setText(BaseMessages.getString(PKG, "BIRTReportOutputDialog.OutputFilename.Label")); //$NON-NLS-1$
        ...
        ColumnInfo[] colinf=new ColumnInfo[]
            {
             new ColumnInfo(BaseMessages.getString(PKG, "BIRTReportOutput.Column.ParameterName"),   ColumnInfo.COLUMN_TYPE_TEXT,    false),
             new ColumnInfo(BaseMessages.getString(PKG, "BIRTReportOutput.Column.FieldName"),       ColumnInfo.COLUMN_TYPE_CCOMBO,  fieldNames, true ),
            };
        ...
        wlProcessor.setText(BaseMessages.getString(PKG, "BIRTReportOutputDialog.Processor.Label")); //$NON-NLS-1$
        ...
        wGet.setText(BaseMessages.getString(PKG, "BIRTReportOutputDialog.Button.GetParameters")); //$NON-NLS-1$
	...
	private void get() {
	  ...
	  try {
        ...
        dialog.setText(BaseMessages.getString(PKG, "BIRTReportOutputDialog.ExtractParameters.FileDialog"));
        ...
        dialog.setFilterNames(new String[] {
            BaseMessages.getString(PKG, "BIRTReportOutputDialog.BIRTReportFiles"),
	    ...
	    new ErrorDialog(shell, 
	      BaseMessages.getString(PKG, "BIRTReportOutputDialog.ErrorReadingParameters.Title"),
	      BaseMessages.getString(PKG, "BIRTReportOutputDialog.ErrorReadingParameters.Message"),
	      e
	    );
	  } finally {
	    shell.setCursor(null);
